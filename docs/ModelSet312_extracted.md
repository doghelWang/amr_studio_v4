# AMR Studio V7.0 - 模型 (ModelSet312.cmodel) 精密解析报告 (V5)
...
- 11. `lamp` (Type: `light`)
- 12. `charger` (Type: `sensor`)
- 13. `MainController` (Type: `mainCPU`)
- 14. `gyro` (Type: `sensor`)
- 15. `smart camera` (Type: `sensor`)
- 16. `smart camera0` (Type: `sensor`)
- 17. `laser-front` (Type: `sensor`)
- 18. `IO module` (Type: `extendedlnterface`)
- 19. `up_sensor` (Type: `sensor`)
- 20. `down_sensor` (Type: `sensor`)
