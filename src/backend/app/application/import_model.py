...
from app.application.exceptions import ApplicationOperationError
from app.infrastructure.projects import data_manager
from app.infrastructure.protobuf import decode_cmodel, split_comp_desc
...
def upload_cmodel_to_project(file) -> dict:
