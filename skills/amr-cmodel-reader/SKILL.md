...
- Relevant schema/runtime paths:
  - `src/backend/skills_v2/schemas_pb/controller_model_comp_desc_pb2.py`
  - `src/backend/skills_v2/schemas_pb/controller_model_abi_set_pb2.py`
  - `src/backend/skills_v2/schemas_pb/controller_model_abi_desc_pb2.py`
  - `src/backend/skills_v2/schemas_pb/comp_desc_runtime.py`
  - `src/backend/skills_v2/schemas_pb/abi_set_runtime.py`
  - `src/backend/skills_v2/schemas_pb/abi_desc_runtime.py`
...
2. Parse with one of these methods:
   ...
   - Local protobuf decoder: `src/backend/skills_v2/cmodel_decoder/decoder.py`.
